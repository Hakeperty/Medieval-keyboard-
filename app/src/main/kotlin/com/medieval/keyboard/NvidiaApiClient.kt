...
- Nothing should sound remotely modern
    ...
    suspend fun elaborateRewrite(sentence: String, period: Int = 0, intensity: Int = 1, rageMode: Boolean = false): String? {
        ...
        val elaboratePrompt = buildString {
            append("You are a wildly creative medieval bard, scholar, and storyteller. ")
            append("You take modern text and COMPLETELY transform it into the most entertaining, ")
            append("dramatic, over-the-top medieval English imaginable.\n\n")
            append("CRITICAL RULES:\n")
            append("1. Fix any spelling or grammar mistakes first. Expand abbreviations: ")
            append("'rn'='right now', 'ngl'='not gonna lie', 'tbh'='to be honest', 'idk'='I don't know', ")
            append("'brb'='be right back', 'omg'='oh my god', 'lol'='laughing', 'smh'='shaking my head', ")
            append("'imo'='in my opinion', 'bc'='because', 'w/'='with', 'im'='I am', 'ur'='you are'.\n")
            append("2. Translate EVERY SINGLE WORD. Do NOT leave ANY modern English in the output. ")
            append("If you see 'plane', say 'great iron sky-vessel'. If you see 'phone', say 'enchanted scrying glass'. ")
            append("NOTHING should remain untranslated.\n")
            append("3. EXPAND everything — even 'hi' becomes a grand proclamation. A single sentence becomes 2-4 vivid medieval sentences.\n")
            append("4. Be CREATIVE and FUNNY — add unexpected medieval metaphors, dramatic oaths, ")
            append("references to dragons, quests, taverns, jousting, sorcery, royal courts.\n")
            append("5. Put a SPIN on modern concepts: phone='enchanted scrying glass', ")
            append("car='iron chariot', Netflix='magical theatre of endless tales', ")
            append("texting='sending ravens', WiFi='the invisible arcane ether', ")
            append("plane/airplane='great iron sky-vessel that doth soar among the clouds', ")
            append("train='the iron serpent upon rails', bus='the common iron carriage'.\n")
            append("6. Use MAXIMUM medieval vocabulary: thou/thee/thy, doth/hath/art/wilt, forsooth/verily/prithee, ")
            append("methinks, 'tis, 'twas, hark, lo, fie, zounds.\n")
            append("7. NEVER explain. NEVER add labels or quotes. Return ONLY the fully rewritten medieval text.\n\n")
            append("Now unleash your full creative medieval power upon this text:\n")
            append(sentence)
        }
