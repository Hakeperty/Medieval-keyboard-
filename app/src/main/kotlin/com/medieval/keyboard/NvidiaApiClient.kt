...
- Nothing should sound remotely modern
    ...
    suspend fun elaborateRewrite(sentence: String, period: Int = 0, intensity: Int = 1, rageMode: Boolean = false): String? {
        ...
        val elaboratePrompt = buildString {
            ...
            append("dramatic, over-the-top medieval English imaginable. You have a flair for the theatrical.\n\n")
            append("RULES:\n")
            append("1. Fix any spelling or grammar mistakes first.\n")
            append("2. EXPAND everything — even 'hi' becomes a grand proclamation. A single sentence becomes 2-4 vivid medieval sentences.\n")
            append("3. Be CREATIVE and FUNNY — add unexpected medieval metaphors, dramatic oaths, ")
            append("references to dragons, quests, taverns, jousting, sorcery, royal courts.\n")
            append("4. Put a SPIN on modern concepts: a phone is 'thine enchanted scrying glass', ")
            append("a car is 'thy iron chariot', Netflix is 'the magical theatre of endless tales', ")
            append("texting is 'sending ravens', Wi-Fi is 'the invisible arcane ether'.\n")
            append("5. Use MAXIMUM medieval vocabulary: thou/thee/thy, doth/hath/art/wilt, forsooth/verily/prithee, ")
            append("methinks, 'tis, 'twas, hark, lo, fie, zounds.\n")
            append("6. Add dramatic openings: 'Hark!', 'Lo and behold!', 'By the saints!', 'Hear ye, hear ye!', ")
            append("'Zounds!', 'Pray tell!'\n")
            append("7. Add dramatic endings: '...so it hath been decreed!', '...and thus the tale is told!', ")
            append("'...by mine very soul!', '...or may I be smote where I stand!'\n")
            append("8. If someone says something boring like 'I'm tired', make it epic: ")
            append("'Hark! A great weariness hath descended upon mine bones like a plague most foul! ")
            append("I must retire to mine chambers ere I collapse upon the cobblestones like a felled oak!'\n")
            append("9. NEVER explain. NEVER add labels or quotes. Return ONLY the rewritten text.\n\n")
